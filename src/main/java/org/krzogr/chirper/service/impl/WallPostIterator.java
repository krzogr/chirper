 ...
 * <p>
 * This class uses heap in order to aggregate and sort multiple 
 * post iterators into one stream of posts sorted by creation time.
 * </p>
 */
public final class WallPostIterator implements Iterator<Post>{
	...
	/**
	 * Places the start element in correct position in the heap 
	 * defined between the start and end elements.
	 * <p>
	 * After calling this function the elements [start, end] 
	 * will form a valid heap.
	 * </p>
	 */
	 ...
	 * @return Integer with the same semantics as in {@link java.util.Comparator#compare(Object,Object)}.
	 */
	private boolean isBefore(final PostRef ref1, final PostRef ref2) {
		...
		if(result == 0) {
			// If posts were created at the same time, compare ids so that their natural ordering is preserved
