...
public final class DurationFormatter {
	 ...
	 * @param highestUnitOnly Use only the highest time unit which the duration could be described with.
	...
	public static String format(final Duration duration, final boolean highestUnitOnly) {
		...
		long seconds = TimeUnit.MILLISECONDS.toSeconds(duration.minusDays(days).minusHours(hours).minusMinutes(minutes).toMillis());
