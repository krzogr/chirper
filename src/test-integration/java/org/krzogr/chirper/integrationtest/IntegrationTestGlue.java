...
/**
 * Helper class used to glue together cucumber integration tests with java classes.
 * <p>
...
public class IntegrationTestGlue {
	...
	private void runCommand(String command) {
		try {
			BufferedReader input = new BufferedReader(new StringReader(command.toString() + "\n"));
			
			ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
			CommandFactory commandFactory = new CommandFactoryImpl(userManager, new PrintStream(outputStream), clock);
	...
	public void givenApplicationStarts(String date, String time, String timezoneID) throws Throwable {
