...
/**
 * Special implementation of Clock which enables to manually change current date/time.
 */
public class ManualClock extends Clock {
    ...
    public void setDateTime(String date, String time) {
    	LocalDateTime newDateTime = LocalDateTime.parse(date + " " + time, DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
