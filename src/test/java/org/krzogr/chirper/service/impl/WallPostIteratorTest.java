...
public class WallPostIteratorTest {
	...
	public void testMultipleEmptyIterators() {
		WallPostIterator iter = new WallPostIterator(asList(iterator(), iterator(), iterator()));
		assertEmpty(iter);
	}

	@Test
	public void testSingleIteratorOnePost() {
		WallPostIterator iter = new WallPostIterator(asList(iterator(post(1, "10:00:00"))));
		assertPostIds(iter, 1);
	}

	@Test
	public void testSingleIteratorTwoPosts() {
		WallPostIterator iter = new WallPostIterator(asList(iterator(post(1, "10:00:00"), post(2, "10:00:00"))));
		assertPostIds(iter, 1, 2);
	}
	
	@Test
	public void testAllCreationTimesEqualSortByPostId() {
		Iterator<Post> iterator1 = iterator(post(9, "10:00:00"), post(8, "10:00:00"));
		Iterator<Post> iterator2 = iterator(post(7, "10:00:00"), post(6, "10:00:00"), post(5, "10:00:00"));
		Iterator<Post> iterator3 = iterator(post(4, "10:00:00"), post(3, "10:00:00"), post(1, "10:00:00"));
		Iterator<Post> iterator4 = iterator(post(2, "10:00:00"));
		
		WallPostIterator iter = new WallPostIterator(asList(iterator1, iterator2, iterator3, iterator4));
		assertPostIds(iter, 9, 8, 7, 6, 5, 4, 3, 2, 1);
	}

	@Test
	public void testSortByCreationTime() {
		Iterator<Post> iterator1 = iterator(post(9, "10:00:32"), post(8, "10:00:27"));
		Iterator<Post> iterator2 = iterator(post(7, "10:00:33"), post(6, "10:00:31"), post(5, "10:00:28"));
		Iterator<Post> iterator3 = iterator(post(4, "10:00:34"), post(3, "10:00:30"), post(1, "10:00:29"));
