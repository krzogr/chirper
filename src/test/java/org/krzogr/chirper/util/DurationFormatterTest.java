...
public class DurationFormatterTest {
	...
	private void assertFormattingAllUnits(String startDateTimeStr, String endDateTimeStr, String expected) {
		assertFormatting(startDateTimeStr, endDateTimeStr, expected, false);
	}
	
	private void assertFormattingHighestUnit(String startDateTimeStr, String endDateTimeStr, String expected) {
		assertFormatting(startDateTimeStr, endDateTimeStr, expected, true);
	}

	private void assertFormatting(String startDateTimeStr, String endDateTimeStr, String expected, boolean highestUnitOnly) {
		...
		String actual = DurationFormatter.format(Duration.between(startDateTime, endDateTime), highestUnitOnly);
